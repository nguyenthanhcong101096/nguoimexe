...
# USER
hola  = FactoryBot.create(:user, email: 'nguyenthanhcong@gmail.com', phone: '0338529345', username: 'Nguyễn Thành Công', avatar: Rack::Test::UploadedFile.new(Rails.root.join('app', 'javascript', 'images', 'cong.png'), 'image/png'), address: 'aaaa', password: 'password', password_confirmation: 'password')
holo  = FactoryBot.create(:user, email: 'nguyenthanhcong1@gmail.com', phone: '0338529346', username: 'Thiên Kim', avatar: Rack::Test::UploadedFile.new(Rails.root.join('app', 'javascript', 'images', 'lien.png'), 'image/png'), address: 'aaaa', password: 'password', password_confirmation: 'password')
...
blog          = FactoryBot.create(:blog, user_id: hola.id, img: img, mod: 'motosg', title: 'BLV Quang Huy: ‘Tuyển Việt Nam phải kiên nhẫn nếu muốn hạ Jordan')
