...
conversation_4  = FactoryBot.create(:conversation, name: 'groups')
...
room_4 = [holo, helo, hola].each { |user| FactoryBot.create(:room_chat, sender_id: user.id, conversation_id: conversation_4.id) }
...
messages_room_4 = 15.times { FactoryBot.create(:message, conversation_id: conversation_4.id, sender_id: [hola, holo, helo].sample.id) }
