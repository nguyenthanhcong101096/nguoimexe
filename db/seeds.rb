...
# GROUP
group1      = FactoryBot.create(:group, name: 'motosg', address: 'Quận 1 Hồ Chí Minh', user: hola)
group2      = FactoryBot.create(:group, name: 'damme', address: 'Quận 1 Hồ Chí Minh', user: holo)

[hola, holo, helo].map { |u| FactoryBot.create(:user_group, user: u, group: group1) }
FactoryBot.create(:user_group, user: hola, group: group2)
